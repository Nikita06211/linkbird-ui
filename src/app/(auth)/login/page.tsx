    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-md bg-white rounded-2xl p-8 relative border border-gray-200 shadow-sm">
        ...
        <div className="relative z-10">
          ...
          {/* Google Login */}
          <button
            className="w-full flex items-center text-gray-800 justify-center gap-3 border border-gray-300 rounded-lg py-3 mb-4 hover:bg-gray-50 transition-colors"
          >
          ...
          {/* Email Login */}
          <button
            className="w-full flex items-center justify-center gap-3 bg-blue-600 text-white rounded-lg py-3 hover:bg-blue-700 transition-colors"
          >
